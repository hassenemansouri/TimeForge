...
public class PayementService {
  ...
  public ResponsePayment generatePayment(Integer amount) throws IOException {
    ...
    requestHashMap.put("success_link", "http://localhost:8100/payment/success");
    requestHashMap.put("fail_link", "http://localhost:4200/payment/error");
    ...
    try (response) {
      ...
      return ResponsePayment.builder().payment_id(jsonNode.path("result").path("payment_id").asText()) // Payment ID
